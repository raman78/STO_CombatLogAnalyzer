...
- the Red Alert events (Tholian, Borg, Tzenkethi, Elachi) are now recognized and always shown as Normal, and Red Alert: Tholian is no longer mistaken for Azure Nebula Rescue (both involve Tholian ships)
