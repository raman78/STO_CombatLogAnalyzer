...
- the "Red Alert: Tholian", "Red Alert: Borg" and "Red Alert: Tzenkethi" events are now recognized and always shown as Normal, and Red Alert: Tholian is no longer mistaken for Azure Nebula Rescue (both involve Tholian ships)
